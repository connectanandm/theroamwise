        ...
        if (typeof gsap !== "undefined" && typeof ScrollTrigger !== "undefined") {
            ...
            if (!isMobile) {
                ...
                createScrollAnimation('.duru-cta-slide-up', {
                    start: "top 90%", end: "top 70%",
                    from: { opacity: 0 },
                    to: { opacity: 1, duration: 1, immediateRender: false }
                });
            }
            ...
            if (!isMobile) {
                ...
                // Rotate / 3D effects (with large transforms)
        ...
        if (typeof gsap !== "undefined" && typeof ScrollTrigger !== "undefined") {
            ...
            if (elasticCards.length) {
                ...
                elasticCards.forEach((card, i) => {
                    ...
                    const spreadAmount = window.innerWidth <= 767 ? 80 : 180;
                    elasticTl.to(card, {
                        x: offset * spreadAmount,
                        rotation: offset * 8,
                        ease: "none"
                    }, 0);
                });
